...
@UdfDescription(name = "loan_installment", category = "LOAN", author = "Spring & Kafka Bootcamp - Timpamungkas", version = "4.0.0", description = "User defined function for sample scalar loan business logic.")
